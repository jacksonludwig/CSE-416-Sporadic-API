...
const generateQuizIconSubmissionURL = async (req: Request, res: Response) => {
  try {
    ...
    const key = `platforms/${req.params.platform}/${req.params.quiz}/icon.png`;
...
export default generateQuizIconSubmissionURL;
