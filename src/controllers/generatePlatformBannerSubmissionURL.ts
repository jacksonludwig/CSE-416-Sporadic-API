...
const generatePlatformBannerSubmissionURL = async (req: Request, res: Response) => {
  try {
    ...
    const key = `platforms/${req.params.platform}/banner.png`;
...
export default generatePlatformBannerSubmissionURL;
